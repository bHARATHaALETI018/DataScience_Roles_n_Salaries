...
def get_jobs(keyword, num_jobs, verbose, driver_path, sleep_time):
    ...
    url = 'https://www.glassdoor.co.in/Job/united-states-data-scientist-jobs-SRCH_IL.0,13_IN1_KO14,28.htm?suggestCount=0&suggestChosen=false&clickSource=searchBtn&typedKeyword=data%2520sci&typedLocation=United%2520States&context=Jobs&dropdown=0'
    driver.get(url)
    jobs = []
    while len(jobs) < num_jobs:  #If true, should be still looking for new jobs.
        ...
        try:
            ...
            print(" It stopped here!..1")
            #driver.find_element(By.NAME, "selected").click()
        except ElementClickInterceptedException:
            print(" It stopped here!..2")
            pass
        ...
        try:
            ...
            print(" It stopped here!..3")
        except NoSuchElementException:
            print(" It stopped here!..4")
            pass

        
        #Going through each job in this page
        job_buttons = driver.find_elements(by=By.CLASS_NAME , value="jl")  #jl for Job Listing. These are the buttons we're going to click.
...
driver_path = 'C:/Users/Bharath/Downloads/chromedriver.exe'
sleep_time = 3

df = get_jobs("data scientist", 5, False, driver_path, sleep_time)
df